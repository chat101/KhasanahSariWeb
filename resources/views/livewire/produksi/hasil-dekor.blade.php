<div>
    <div x-data="{ activeTab: 'dekor' }" class="w-full">
        ...
        <div class="px-1 py-1 border-b border-gray-200 dark:border-zinc-700 flex items-center justify-between gap-3">
            <div class="flex items-center gap-2">
                ...
                <h2 class="text-base font-semibold">Hasil Dekor</h2>
            </div>
            ...
            <table id="grid-body" class="min-w-full mt-1.5 text-[12px] text-left text-gray-800 dark:text-zinc-100">
                <thead class="bg-gray-50 dark:bg-zinc-900 text-gray-600 dark:text-gray-300 sticky top-0 z-10">
                    <tr>
                        ...
                        <th class="px-3 py-2 text-center border-b border-gray-200 dark:border-zinc-700">Target Giling</th>
                        <th class="px-3 py-2 text-center border-b border-gray-200 dark:border-zinc-700">Realisasi Giling</th>
                ...
                @if (count($perintahproduksi) > 0)
                    ...
                    <tfoot>
                        <tr class="bg-gray-100 dark:bg-zinc-800 font-semibold">
                            <td colspan="2" class="px-3 py-2 text-right border-t border-gray-200 dark:border-zinc-700">
                                Total
                            </td>
                            ...
                            <td class="text-center border-t border-gray-200 dark:border-zinc-700 {{ $totalSelisih < 0 ? 'text-red-600 font-semibold' : '' }}">
