<div class="p-2 space-y-4 bg-gray-100 text-gray-800 text-sm rounded-lg shadow-lg">
    ...
    <div class="flex items-center gap-2 mb-2">
        <div class="relative w-full md:w-1/3">
            <input wire:model.live="search" class="py-1 pl-8 pr-8 border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-300 bg-white text-xs w-full" type="search" placeholder="Cari nama supplier..." />
            ...
            <tr class="transform transition-all duration-150 hover:-translate-y-0.5 hover:shadow-sm">
              ...
              <td class="px-4 py-3">
                <div class="flex items-center gap-2">
                  <button wire:click="edit({{ $produk->id }})" aria-label="Edit {{ $produk->id }}" title="Edit" class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-amber-700 bg-amber-100 hover:bg-amber-200 text-sm">
                  ...
                  <button x-data @click="$dispatch('swal:confirm', { id: {{ $produk->id }} })" aria-label="Hapus {{ $produk->id }}" title="Hapus" class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-red-700 bg-red-100 hover:bg-red-200 text-sm">
            ...
            <tr>
              <td colspan="8" class="px-6 py-10">
                <div class="text-center text-gray-500">
                  ...
                  <div class="text-lg font-medium mt-3">Belum ada supplier</div>
                  <div class="text-xs mt-1">Tambah supplier untuk mulai mengelola data</div>
                  <div class="mt-4">
                    <button wire:click="openModal" class="inline-flex items-center gap-2 px-4 py-2 rounded-md bg-indigo-600 text-white hover:bg-indigo-700">Tambah Supplier</button>
                  </div>
                </div>
              </td>
            </tr>
