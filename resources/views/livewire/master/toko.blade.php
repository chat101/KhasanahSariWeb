<div class="p-2 space-y-4 bg-gray-100 text-gray-800 text-sm rounded-lg shadow-lg">
    ...
    <div class="flex items-center gap-2 mb-2">
        <div class="relative w-full md:w-1/3">
          <input wire:model.live="search"
                 class="py-1 pl-8 pr-8 border border-gray-300 rounded-lg focus:ring-1 focus:ring-blue-300 bg-white text-xs w-full"
            ...
            <tr class="transform transition-all duration-150 hover:-translate-y-0.5 hover:shadow-sm">
              ...
              <td class="px-4 py-3">
                <div class="flex items-center gap-2">
                  <button wire:click="edit({{ $toko->id }})" aria-label="Edit {{ $toko->id }}" title="Edit"
                          class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-amber-700 bg-amber-100 hover:bg-amber-200 text-sm">
                  ...
                  <button x-data @click="$dispatch('swal:confirm', { id: {{ $toko->id }} })" aria-label="Hapus {{ $toko->id }}" title="Hapus"
                          class="inline-flex items-center gap-2 px-3 py-1 rounded-full text-red-700 bg-red-100 hover:bg-red-200 text-sm">
    ...
    @if ($modal)
        <div class="fixed inset-0 flex items-center justify-center bg-black/50 z-50 p-2">
            <div class="bg-white rounded-lg shadow-lg w-full max-w-lg p-4 space-y-3 max-h-[90vh] overflow-y-auto">
                <div class="flex items-center justify-between">
                    <h2 class="text-sm font-semibold">{{ $produkId ? 'Edit Toko' : 'Tambah Toko' }}</h2>
                ...
                <form wire:submit.prevent="store" class="space-y-3">
                    ...
                    <div>
                        ...
                        <select wire:model.defer="area_id"
                                class="w-full border rounded-lg px-3 py-2 text-xs @error('area_id') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input wire:model.defer="nama" type="text"
                               class="w-full border rounded-lg px-3 py-2 text-xs @error('nama') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <textarea wire:model.defer="alamat"
                                  class="w-full border rounded-lg px-3 py-2 text-xs @error('alamat') border-red-500 @enderror"
                                  placeholder="Masukkan alamat toko" rows="2"></textarea>
                    ...
                    <div>
                        ...
                        <input wire:model.defer="apiid" type="text"
                               class="w-full border rounded-lg px-3 py-2 text-xs @error('apiid') border-red-500 @enderror"
                               placeholder="Masukkan API ID (opsional)">
                    ...
                    <div>
                        ...
                        <select wire:model.defer="produksi_sendiri" class="w-full border rounded-lg px-3 py-2 text-xs">
