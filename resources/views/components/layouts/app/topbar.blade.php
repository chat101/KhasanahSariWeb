    ...
    <div
        ...
        <div class="flex items-center gap-3">
            <flux:sidebar.toggle icon="bars-2"
                class="hidden lg:flex items-center justify-center w-10 h-10 rounded-xl border border-white/10 bg-white/5 text-slate-200 hover:bg-white/10 transition" />
        ...
        <div class="flex items-center gap-2 rounded-full bg-white/5 border border-white/10 px-3 py-1.5">
            ...
            <div class="flex flex-col text-right leading-tight">
                ...
                <span class="text-[10px] text-slate-400 uppercase tracking-widest">{{ strtoupper($userArea) }}</span>
            </div>
        </div>
    </div>
</div>
