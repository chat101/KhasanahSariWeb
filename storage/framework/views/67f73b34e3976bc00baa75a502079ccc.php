...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::main','data' => ['class' => 'w-full max-w-none mx-auto px-4 sm:px-6 lg:px-8 xl:px-10']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-full max-w-none mx-auto px-4 sm:px-6 lg:px-8 xl:px-10']); ?>
        <?php echo e($slot); ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\hopusatrunningserverv3\resources\views/components/layouts/app.blade.php ENDPATH**/ ?>