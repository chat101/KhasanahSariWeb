...
<div class="bg-slate-950 text-slate-100 overflow-x-hidden min-h-screen">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4">
            ...
            <div class="relative overflow-hidden rounded-lg md:rounded-xl bg-gradient-to-br from-indigo-900/50 to-slate-900 border border-indigo-500/20 shadow-lg group hover:border-indigo-500/40 transition-all p-2 md:p-4">
                <div class="flex flex-col md:flex-row md:justify-between md:items-start">
                    <div class="min-w-0 flex-1">
                        ...
                        <h3 class="text-sm md:text-2xl font-bold text-white mt-0.5 md:mt-1 shadow-glow-indigo truncate">Rp <?php echo e(number_format($totalSalesToday ?? 0, 0, ',', '.')); ?></h3>
                    </div>
            ...
            <div class="relative overflow-hidden rounded-lg md:rounded-xl bg-gradient-to-br from-emerald-900/50 to-slate-900 border border-emerald-500/20 shadow-lg group hover:border-emerald-500/40 transition-all p-2 md:p-4">
                <div class="flex flex-col md:flex-row md:justify-between md:items-start">
                    <div class="min-w-0 flex-1">
                        ...
                        <h3 class="text-sm md:text-2xl font-bold text-white mt-0.5 md:mt-1 truncate">Rp <?php echo e(number_format($totalCashInToday ?? 0, 0, ',', '.')); ?></h3>
                    </div>
            ...
            <div class="relative overflow-hidden rounded-lg md:rounded-xl bg-gradient-to-br from-fuchsia-900/50 to-slate-900 border border-fuchsia-500/20 shadow-lg group hover:border-fuchsia-500/40 transition-all p-2 md:p-4">
                <div class="flex flex-col md:flex-row md:justify-between md:items-start">
                    <div class="min-w-0 flex-1">
                        ...
                        <h3 class="text-sm md:text-2xl font-bold text-white mt-0.5 md:mt-1"><?php echo e($activeProOrders ?? 0); ?></h3>
                    </div>
            ...
            <div class="grid grid-rows-2 gap-1 md:gap-2">
                <div class="bg-white/5 rounded-lg px-2 md:px-4 py-1.5 md:py-2 border border-white/5 flex items-center justify-between">
                    ...
                    <span class="text-xs md:text-sm font-bold text-white"><?php echo e($jumlahBarang ?? 0); ?></span>
                </div>
                <div class="bg-white/5 rounded-lg px-2 md:px-4 py-1.5 md:py-2 border border-white/5 flex items-center justify-between">
                    <span class="text-[9px] md:text-xs text-slate-400 font-medium">Suppliers</span>
                    <span class="text-xs md:text-sm font-bold text-white"><?php echo e($jumlahSupplier ?? 0); ?></span>
                </div>
            </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-4 pb-6">
            ...
            <div class="bg-slate-900/50 backdrop-blur-sm rounded-lg md:rounded-xl border border-white/5 flex flex-col h-[300px] md:h-full overflow-hidden">
                <div class="px-3 md:px-4 py-2 md:py-3 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
                    ...
                    <a href="<?php echo e(route('rekapbrgmsk')); ?>" class="text-[9px] md:text-[10px] font-medium text-blue-300 hover:text-white transition-colors">View All</a>
                </div>
                <div class="flex-1 overflow-y-auto w-full">
                    <table class="w-full text-[10px] md:text-xs text-left text-slate-400">
                        ...
                        <tbody class="divide-y divide-white/5">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $recentPurchases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $purchase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-white/5 transition-colors">
                                    <td class="px-2 md:px-4 py-1.5 md:py-2.5 whitespace-nowrap"><?php echo e(\Carbon\Carbon::parse($purchase->tanggal)->format('d/m')); ?></td>
                                    <td class="px-2 md:px-4 py-1.5 md:py-2.5 text-slate-300 font-medium truncate max-w-[80px] md:max-w-[120px]"><?php echo e($purchase->supplier->nama_supplier ?? '-'); ?></td>
                                    <td class="px-2 md:px-4 py-1.5 md:py-2.5 truncate max-w-[60px] md:max-w-full"><?php echo e($purchase->no_po ?? '-'); ?></td>
                                </tr>
            ...
            <div class="bg-slate-900/50 backdrop-blur-sm rounded-lg md:rounded-xl border border-white/5 flex flex-col h-[300px] md:h-full overflow-hidden">
                <div class="px-3 md:px-4 py-2 md:py-3 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
                    ...
                    <a href="<?php echo e(route('uangmsk')); ?>" class="text-[9px] md:text-[10px] font-medium text-emerald-300 hover:text-white transition-colors">View All</a>
                </div>
                <div class="flex-1 overflow-y-auto w-full">
                    <table class="w-full text-[10px] md:text-xs text-left text-slate-400">
                        <thead class="text-[8px] md:text-[10px] text-slate-500 uppercase bg-black/20 sticky top-0 backdrop-blur-md">
                        ...
                        <tbody class="divide-y divide-white/5">
                            <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $recentCashIns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cash): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="hover:bg-white/5 transition-colors">
                                    <td class="px-2 md:px-4 py-1.5 md:py-2.5 text-slate-300 font-medium truncate max-w-[70px] md:max-w-[100px]"><?php echo e($cash->tokos->nmtoko ?? '-'); ?></td>
                                    <td class="px-2 md:px-4 py-1.5 md:py-2.5 text-right font-mono text-emerald-400 text-[9px] md:text-xs"><?php echo e(number_format($cash->jumlah_uang, 0, ',', '.')); ?></td>
                                    <td class="px-2 md:px-4 py-1.5 md:py-2.5 truncate max-w-[60px] md:max-w-[100px]"><?php echo e($cash->keterangan ?? '-'); ?></td>
                                </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="3" class="p-3 md:p-4 text-center italic text-[10px] md:text-xs">No data</td>
        ...
        <div class="space-y-3 md:space-y-4 pb-8">
            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2">
                ...
                <div class="text-[9px] md:text-xs text-slate-400">
                    Periode: <?php echo e(\Carbon\Carbon::parse($startDate)->format('d M')); ?> - <?php echo e(\Carbon\Carbon::parse($endDate)->format('d M Y')); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-4">
                ...
                <div class="rounded-lg md:rounded-xl bg-gradient-to-br from-blue-900/50 to-slate-900 border border-blue-500/20 shadow-lg p-3 md:p-4">
                    ...
                    <div class="mt-1 md:mt-2 text-xl md:text-3xl font-bold text-blue-400"><?php echo e($overallAchievement); ?>%</div>
                    <div class="mt-0.5 md:mt-1 text-[8px] md:text-[10px]
                        <?php echo e($overallAchievement >= 100 ? 'text-green-400' : ($overallAchievement >= 80 ? 'text-yellow-400' : 'text-red-400')); ?>">
                        <?php if($overallAchievement >= 100): ?>
                            ✓ Tercapai
                        <?php elseif($overallAchievement >= 80): ?>
                            ⚠ Hampir
                        <?php else: ?>
                            ✗ Belum
                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="rounded-lg md:rounded-xl bg-gradient-to-br from-green-900/50 to-slate-900 border border-green-500/20 shadow-lg p-3 md:p-4">
                    ...
                    <div class="mt-1 md:mt-2 text-sm md:text-2xl font-bold text-green-400 truncate">Rp <?php echo e(number_format(collect($dashboardData)->sum('target'), 0, ',', '.')); ?></div>
                </div>
                ...
                <div class="rounded-lg md:rounded-xl bg-gradient-to-br from-purple-900/50 to-slate-900 border border-purple-500/20 shadow-lg p-3 md:p-4">
                    ...
                    <div class="mt-1 md:mt-2 text-sm md:text-2xl font-bold text-purple-400 truncate">Rp <?php echo e(number_format(collect($dashboardData)->sum('actual'), 0, ',', '.')); ?></div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3 gap-3 md:gap-4">
                ...
                <!--[if BLOCK]><![endif]--><?php if(count($dashboardData)): ?>
                    <div class="bg-slate-900/50 backdrop-blur-sm rounded-lg md:rounded-xl border border-white/5 shadow-lg p-3 md:p-4">
                        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-2 md:mb-4">
                            ...
                            <select wire:model="selectedWilayah" class="text-xs md:text-sm bg-slate-800/80 border border-white/10 rounded-lg px-3 py-2 text-slate-100 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $wilayahOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wilayah): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($wilayah['id']); ?>"><?php echo e($wilayah['nama']); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                            </select>
                        </div>
                        <div id="chartDataPayload" data-chart='<?php echo json_encode($chartData ?? ['labels' => [], 'datasets' => []], 512) ?>' class="hidden"></div>
                ...
                <!--[if BLOCK]><![endif]--><?php if(count($dailyBreakdown ?? [])): ?>
                    <div class="bg-slate-900/50 backdrop-blur-sm rounded-lg md:rounded-xl border border-white/5 overflow-hidden">
                        ...
                        <div class="overflow-y-auto max-h-[250px] md:max-h-[300px]">
                            <table class="w-full text-[10px] md:text-xs text-slate-400">
                                ...
                                <tbody class="divide-y divide-white/5">
                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $dailyBreakdown; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="hover:bg-white/5">
                                            <td class="px-2 md:px-3 py-1.5 md:py-2 text-slate-300"><?php echo e(\Carbon\Carbon::parse($d['date'])->format('d/m')); ?></td>
                                            <td class="px-2 md:px-3 py-1.5 md:py-2 text-right text-[9px] md:text-xs"><?php echo e(number_format($d['target']/1000, 0)); ?>K</td>
                                            <td class="px-2 md:px-3 py-1.5 md:py-2 text-right text-[9px] md:text-xs <?php echo e($d['achievement_pct'] >= 100 ? 'text-green-400' : ($d['achievement_pct'] >= 80 ? 'text-yellow-400' : 'text-red-400')); ?>"><?php echo e(number_format($d['actual']/1000, 0)); ?>K</td>
                                            <td class="px-2 md:px-3 py-1.5 md:py-2 text-center font-bold text-[9px] md:text-xs <?php echo e($d['achievement_pct'] >= 100 ? 'text-green-400' : ($d['achievement_pct'] >= 80 ? 'text-yellow-400' : 'text-red-400')); ?>"><?php echo e($d['achievement_pct']); ?>%</td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
                                </tbody>
                            </table>
                ...
                <div class="bg-slate-900/50 backdrop-blur-sm rounded-lg md:rounded-xl border border-white/5 overflow-hidden">
                    ...
                    <div class="overflow-y-auto max-h-[250px] md:max-h-[300px]">
                        <table class="w-full text-[10px] md:text-xs text-slate-400">
                            ...
                            <tbody class="divide-y divide-white/5">
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $filteredDashboardData ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="hover:bg-white/5">
                                        <td class="px-2 md:px-3 py-1.5 md:py-2 font-medium text-slate-300 truncate max-w-[80px] md:max-w-full"><?php echo e($row['toko_nama']); ?></td>
                                        <td class="px-2 md:px-3 py-1.5 md:py-2 text-right text-[8px] md:text-[10px]"><?php echo e(number_format($row['target']/1000, 0)); ?>K</td>
                                        <td class="px-2 md:px-3 py-1.5 md:py-2 text-right font-semibold text-[8px] md:text-[10px]
                                            <?php echo e($row['achievement_pct'] >= 100 ? 'text-green-400' : ($row['achievement_pct'] >= 80 ? 'text-yellow-400' : 'text-red-400')); ?>">
                                            <?php echo e(number_format($row['actual']/1000, 0)); ?>K
                                        </td>
                                        <td class="px-2 md:px-3 py-1.5 md:py-2 text-center font-bold text-[9px] md:text-xs
                                            <?php echo e($row['achievement_pct'] >= 100 ? 'text-green-400' : ($row['achievement_pct'] >= 80 ? 'text-yellow-400' : 'text-red-400')); ?>">
                                            <?php echo e($row['achievement_pct']); ?>%
                                        </td>
                                    </tr>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                    <tr>
    ...
    <!-- End Content Wrapper -->
</div><?php /**PATH C:\laragon\www\hopusatrunningserverv3\resources\views/dashboard.blade.php ENDPATH**/ ?>