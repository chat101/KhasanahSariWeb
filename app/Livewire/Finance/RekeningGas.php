...
class RekeningGas extends Component
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        ->when($s !== '', function ($q) use ($s) {
            ...
            $q->where(function ($w) use ($like) {
                $w->where('nmtoko', 'LIKE', $like)
                  ->orWhereHas('gass', function ($rq) use ($like) {
        ...
        return view('livewire.finance.rekening-gas', compact('gas', 'allTokos'));
    }
