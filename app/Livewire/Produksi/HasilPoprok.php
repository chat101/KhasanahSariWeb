...
use App\Models\Produksi\HasilPoprok as HasilPoprokModel;
use Illuminate\Support\Collection;
class HasilPoprok extends Component
{
        ...
        $rows = DB::table('mproducts as mp')
            ...
            ->leftJoin('hasil_divisi as hd', function ($j) {
                $j->on('hd.mproducts_id', '=', 'mp.id')
                    ...
                    ->where('hd.divisi_id', '=', 6);   // ✅ filter divisi
            })
            ->whereRaw('
    ...
    {
        return view('livewire.produksi.hasil-poprok', [
