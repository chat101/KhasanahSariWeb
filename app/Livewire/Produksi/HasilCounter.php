...
use App\Models\Produksi\HasilCounter as HasilCounterModel;
use Illuminate\Support\Collection;

class HasilCounter extends Component
{
        ...
        private function loadDataFromNet(): void
    {
        ...
        $rows = DB::table('mproducts as mp')
            ...
            ->leftJoin('hasil_counter as hd', function ($j) {
    ...
    public function submit()
    {
        ...
        DB::transaction(function () use ($rows) {
            foreach ($rows as $idx => $row) {
                ...
                HasilCounterModel::updateOrCreate(
                    [
    ...
    {
        return view('livewire.produksi.hasil-counter', [
