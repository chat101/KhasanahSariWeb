       ...
       Route::middleware(['auth'])->group(function () {
        ...
        Route::get('/loss-bahan', InputLossBahan::class)->name('loss-bahan');
              Route::get('/kontribusi-harian-toko', KontribusiHarianToko::class)->name('kontribusi-harian-toko');
                // Export kontribusi harian area (hindari Livewire hydration error)
        Route::get('/kontribusi-area-export', function () {
            return \App\Livewire\Operasional\KontribusiHarianArea::exportHandler();
        })->name('kontribusi-area.export');
    });
